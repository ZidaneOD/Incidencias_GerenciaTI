...
public interface UsuarioImagenRepository extends JpaRepository<UsuarioImagen, Integer> {
    @Query(value = "INSERT INTO tb_usua_s3() VALUES(id_usua_s3=:idUsuaS3,id_usua=:idUsua,nomb_img=:nombImg)", nativeQuery = true)
    UsuarioImagen guardar(Integer idUsuaS3, Integer idUsua, String nombImg);
